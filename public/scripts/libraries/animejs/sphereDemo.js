const sphereWrapper = htmlToElement(`<div id='sphereEffect' class="animation-wrapper">
...
const startEffectSphere = function () {
    ...
    document.querySelector('.sphere path').style = "fill: url(#sphereGradient); stroke-width: 1px; stroke: rgba(80,80,80,.35); backface-visibility: hidden;";
    sphereAnimation();
}
const clearEffectSphere = function () {
    document.querySelector('body').removeChild(document.querySelector('#sphereEffect'));
}

var effectMap = effectMap || new Map();
effectMap.set("Sphere Animation", [startEffectSphere, clearEffectSphere])